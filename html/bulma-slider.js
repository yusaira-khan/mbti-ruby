  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__events__ = __webpack_require__(
          1
        );
        var _extends =
          Object.assign ||
        ...
        var bulmaSlider = (function (_EventEmitter) {
          ...
          _createClass(
            ...
            [
              ...
              {
                key: "_findRightOutputForSlider",
                value: function _findRightOutputForSlider() {
                  var _this2 = this;
                  ...
                  Array.from(outputs).forEach(function (output) {
                    if (
                      output.htmlFor ==
                      _this2.element.getAttribute("id") + "-right"
                    ) {
                      result = output;
                      return true;
                    }
              ...
              },
              {
                ...
                value: function onSliderInput(e) {
                  ...
                  if (this.outputRight) {
                    this.outputRight.value =
                      this.element.getAttribute("max") - this.element.value;
                  }
